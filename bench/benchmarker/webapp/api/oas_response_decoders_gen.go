...
func decodeChairPostRequestPaymentResponse(resp *http.Response) (res ChairPostRequestPaymentRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &ChairPostRequestPaymentNoContent{}, nil
	case 400:
		// Code 400.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
		...
		case ct == "application/json":
			...
			var response ChairPostRequestPaymentBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 404:
		...
		case ct == "application/json":
			...
			var response ChairPostRequestPaymentNotFound
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
