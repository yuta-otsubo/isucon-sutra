...
func (s *Server) decodeAppPostRequestEstimateRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request OptAppPostRequestEstimateReq
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
...
func (s *Server) decodeOwnerPostRegisterRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request OptOwnerPostRegisterReq
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
